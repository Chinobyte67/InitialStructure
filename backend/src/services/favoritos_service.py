...
class FavoritosService:
    def __init__(self):
        self.favoritos_repo = FavoritosRepository()
    ...
    def get_favoritos_by_id(self, favoritos_id: int) -> FavoritosResponseDTO:
    ...
    def update_favoritos(self, favoritos_id: int, favoritos_dto: CreateFavoritosDTO) -> FavoritosResponseDTO:
