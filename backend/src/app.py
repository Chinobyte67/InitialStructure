...
from src.routers import auth_router, user_router, cancion_router, album_router, artista_router, favoritos_router, playlist_canciones_router, playlist_router, reproduccion_router
